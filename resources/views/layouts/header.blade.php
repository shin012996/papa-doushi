<header class="bg-white shadow-sm">
  <div class="container-fluid  navbar navbar-expand-md">
    <a class="navbar-brand col-8 col-md-3 col-lg-3 col-xl-3" href="{{ url('/papa-doushi') }}">
    ...
    <ul class="navbar-nav sp">
      ...
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
        ...
        <!-- Navbar -->
      <div class="collapse navbar-collapse col-md-6 col-lg-7 col-xl-7 justify-content-lg-between" id="navbarSupportedContent">
        <ul class="navbar-nav flex-row flex-md-column flex-lg-row col-12 col-md-8 col-lg-6 col-xl-4 justify-content-lg-between mx-auto">
          <!-- 検索バー -->
          <form class="form-inline col-8 col-md-4 col-lg-10 col-xl-10">
            <div class="d-flex">
        ...
        <ul class="navbar-nav col-md-6 col-lg-4">
          <li class="nav-item col-5 col-md-10 col-lg-9 col-xl-7">
        ...
        <ul class="navbar-nav flex-row flex-md-column flex-lg-row col-10 col-md-9 col-lg-4 justify-content-lg-between mx-auto">
            <!-- Authentication Links -->
            @guest
                <li class="nav-item col-6 col-md-6 col-lg-9 col-xl-7">
